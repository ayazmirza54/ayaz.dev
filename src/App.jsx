    ...
    <>
      <div className="container bg-[#17181c]">
        ...
        <main>
          ...
          <div className=" flex text-white text-2xl md:text-3xl p-[10px] md:p-[20px] text-center"><FaDev className='inline-block align-text-top'/>&nbsp;About my tech expertise</div><br/>
